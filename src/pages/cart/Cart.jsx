...
function Cart() {
  ...
  const buyNow = async () => {
    ...
    var options = {
      key: "rzp_test_GV7SXyM0lBLPtf",
      key_secret: "iyDvrkxo1Srvojj0x71irm8M",
  ...
  return (
    <Layout>
      <div
        className="h-screen bg-gray-100 pt-5 py-[100%]"
        style={{
              ...
              return (
                <>
                  ...
                  >
                    ...
                    />
                    <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between gap-2">
                      <div className="mt-5 sm:mt-0 ">
                        ...
                        <div className="w-fit md:w-52 flex items-center justify-between text-gray-500 gap-2 md:gap-4 border p-2 md:p-3 mt-2">
